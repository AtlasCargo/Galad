...
- Influence-first pipeline outputs
  - `data/output/top_actors_influence.csv` (3,867 rows, 10 cols)
  - `data/output/org_classification_map.csv` (3,867 rows, 6 cols)
...
- Wikidata seed (companies with revenue property; ~400 entities, generated locally)
